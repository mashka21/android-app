...
public class AdminAdapter extends FirebaseRecyclerAdapter<AdminModel, AdminAdapter.ViewHolder> {

    Context context;
    String myString;

    public AdminAdapter(@NonNull FirebaseRecyclerOptions<AdminModel> options, Context context ,String myString) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull AdminModel model) {
            ...
            public void onClick(View view) {
                ...
                update_pr.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child(myString)
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                //Toast.makeText(context, "From" + myString, Toast.LENGTH_SHORT).show();
